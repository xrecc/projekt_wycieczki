...
<form id="search-form" class="pure-form pure-form-stacked" onsubmit="ajaxPostForm('search-form','{$conf->action_root}searchReservationListPart','table'); return false;">
	...
	<fieldset>
		...
		<button type="submit" class="pure-button pure-button-primary">Filtruj</button>
          ...
          <section>
          <div id="table">
          {include file="searchlistarezerwacji.tpl"}
          </div>
          </section>
        </div>
      </section>
